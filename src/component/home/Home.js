  ...
  return (
    <div className='home'>
      <div className="img">
       ...
       <div className='btns'>
       <Button type='submit' onClick={search} style={{color:'grey',marginRight:"5px"}}>Google Search</Button>
       <Button style={{color:'grey',marginLeft:"5px"}}>I am Lucky Today</Button>
       </div>
       </form>
    </div>
  )
